    ...
    class Game:
        ...
        def showMenu(self):
            ...
            buttons = Allbuttons([
                ...
                #Button(self.screenRect.centerx-50, self.screenRect.centery-30, 40, 100, 'RULES', (0, 4, 255), (10,240,110), (160,245,225), self.infoTab),
        ...
        def startGame(self):
            ...
            buttons = Allbuttons([
                ...
                Button(725, 25, 30, 70, 'PAUSE', (0, 4, 255), (10,240,110), (160,245,225), self.goPause, 26),
